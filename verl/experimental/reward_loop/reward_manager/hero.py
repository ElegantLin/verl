...
class HeroRewardManager(RewardManagerBase):
    ...
    This manager computes verifier-side reward per sample. The dense RM component and
    group-level HERO shaping are applied in the reward loop orchestration layer.
    """
    ...
    async def run_single(self, data: DataProto) -> dict:
        ...
        if isinstance(result, dict):
            ...
            rule_score = float(result)
            reward_extra_info["score"] = rule_score

        reward_extra_info["acc"] = rule_score
